...
public class GameMaker implements FX.GameMaker<Integer, Integer, Board, String, Game, Move, Player, GameRunner> {
	...
	public List<PlayerMaker<Integer, Integer, Board, String, Game, Move, Player>> getPlayerMakers() {
		...
		l.add(new HDMiniMaxMaker("Pits AI Maximizer", HDHeuristicSet.pitsMaximizer));
		l.add(new HDMiniMaxMaker("Kalaha AI Maximizer", HDHeuristicSet.kalahaMaximizer));
		l.add(new HDMiniMaxMaker("Kalaha AI Minimizer", HDHeuristicSet.kalahaMinimizer));
		l.add(new HDMiniMaxMaker("Squared Pits AI Minimizer", HDHeuristicSet.squaredPitsMinimizer));
		l.add(new SimplePlayerMaker<Integer, Integer, Board, String, Game, Move, Player>("Finishing Sequence AI", HDMyTurnAI.class));
		l.add(new SimplePlayerMaker<Integer, Integer, Board, String, Game, Move, Player>("Kalaha Master", HDKalahaMaster.class));
		return l;
	}
